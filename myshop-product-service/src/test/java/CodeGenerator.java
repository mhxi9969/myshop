...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        try {
            // 设置模块名
            String basePath = "myshop-product-service/src/main";
            // 设置包名
            String packageBase = "top.mhxi.myshop.product";
            // 设置实体类名，可以多个
            List<String> entities = Arrays.asList("Attr","AttrValue","Brand","Category","ProductSku","ProductSpu","SkuAttrValue");
