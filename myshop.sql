...
-- 正在导出表  myshop_order.order_order 的数据：~1 rows (大约)
...
INSERT INTO `order_order` (`id`, `user_id`, `total_amount`, `status`, `receiver_name`, `receiver_phone`, `receiver_address`, `trade_id`, `pay_time`, `delivery_time`, `receive_time`, `close_time`, `remark`, `create_time`, `update_time`) VALUES
	(1182845107733401600, 1182707317808959488, 600.00, 1, '山本', '08012345678', '東京', 'https://qr-stg.sandbox.paypay.ne.jp/28180104z5iSmc2AykVkjwh8', NULL, NULL, NULL, NULL, NULL, '2025-11-03 23:05:17', '2025-11-03 23:05:57');
...
-- 正在导出表  myshop_order.order_order_item 的数据：~2 rows (大约)
...
INSERT INTO `order_order_item` (`id`, `order_id`, `sku_id`, `sku_name`, `sku_picture`, `sku_price`, `sku_quantity`, `total_price`, `create_time`, `update_time`) VALUES
	(1182845107909562368, 1182845107733401600, 1182835431805423616, 'DELL デル ノートパソコン Intel 5090', 'https://top-mhxi-myshop-product-images.s3.ap-northeast-1.amazonaws.com/product/666e59c8-1653-469d-ba66-de5d7709e93a-Snipaste_2025-11-02_14-20-49.jpg', 200.00, 2, 400.00, '2025-11-03 23:05:17', '2025-11-03 23:05:17'),
	(1182845108018614272, 1182845107733401600, 1180839507763793920, 'アップル Apple スマートフォン iPhone 17 ブラック 256GB ', 'https://top-mhxi-myshop-product-images.s3.ap-northeast-1.amazonaws.com/product/1cdf5419-9ca7-47cc-938e-2509fe2728f7-Snipaste_2025-10-27_12-59-30.jpg', 100.00, 2, 200.00, '2025-11-03 23:05:17', '2025-11-03 23:05:17');
...
INSERT INTO `product_product_sku` (`id`, `name`, `spu_id`, `picture`, `price`, `stock`, `create_time`, `update_time`) VALUES
	(1180668431482097664, 'アップル Apple スマートフォン iPhone 17 ホワイト 256GB ', 1180655856363114496, 'https://top-mhxi-myshop-product-images.s3.ap-northeast-1.amazonaws.com/product/31d39c6a-9f88-4031-bdc9-16e18f782bf1-Snipaste_2025-10-27_12-58-21.jpg', 100.00, 100, '2025-10-28 22:55:53', '2025-11-03 22:21:58'),
	...
	(1180839507763793920, 'アップル Apple スマートフォン iPhone 17 ブラック 256GB ', 1180655856363114496, 'https://top-mhxi-myshop-product-images.s3.ap-northeast-1.amazonaws.com/product/1cdf5419-9ca7-47cc-938e-2509fe2728f7-Snipaste_2025-10-27_12-59-30.jpg', 100.00, 95, '2025-10-29 10:15:41', '2025-11-03 23:05:17'),
	...
	(1182835343095894016, 'DELL デル ノートパソコン Intel 5080', 1182834903872573440, 'https://top-mhxi-myshop-product-images.s3.ap-northeast-1.amazonaws.com/product/7708c303-5295-4c4c-8d93-c4da7a200221-Snipaste_2025-11-02_14-20-49.jpg', 100.00, 100, '2025-11-03 22:26:28', '2025-11-03 22:26:28'),
...
INSERT INTO `product_product_spu` (`id`, `name`, `brand_id`, `category1_id`, `category2_id`, `status`, `create_time`, `update_time`) VALUES
	(1180655856363114496, 'iphone17', 1180133221678059520, 1180134230244593664, 1180134265061511168, 1, '2025-10-28 22:05:55', '2025-11-03 22:40:22'),
	(1182834903872573440, 'DELL NOTE', 1182833265640345600, 1180134230244593664, 1180629958180081664, 1, '2025-11-03 22:24:44', '2025-11-03 22:40:28');
...
-- 正在导出表  myshop_product.product_sku_attr_value 的数据：~16 rows (大约)
...
-- 正在导出表  myshop_user.user_user 的数据：~1 rows (大约)
DELETE FROM `user_user`;
/*!40000 ALTER TABLE `user_user` DISABLE KEYS */;
INSERT INTO `user_user` (`id`, `name`, `password`, `email`, `phone`, `role`, `create_time`, `update_time`) VALUES
	(1180156514984398848, '1', '$2a$10$g3HBEe4Y6UnLiu/RMA40QOQirTP9JzTbgpjh3jDodAsMULXEt.hq.', NULL, NULL, 'USER', '2025-10-27 13:01:43', '2025-11-03 13:58:13'),
	(1182707317808959488, '2', '$2a$10$7HmMKA5f2mHfi/RGXIp6leJqCW66N0MI4L0ehzsGjcY1tmvc4Wf92', NULL, NULL, 'ADMIN', '2025-11-03 13:57:44', '2025-11-03 13:58:07');
